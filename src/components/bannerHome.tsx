...
const BannerHome = () => {
  ...
  const goToContact = () => {
    const element = document.getElementById("contact_home_section");
  ...
  return (
    <div
      ...
      className="lg:bg-white h-screen lg:max-h-90 flex justify-center items-center text-white text-center "
    >
