...
const ProjectsContainer = () => {
    return (
        <div className="py-10 w-full px-20 2xl:px-36 max-w-1500 font-roboto flex flex-col">
            ...
            <div className="grid gap-16 mt-10 grid-cols-3 h-full overflow-y-scroll p-5 scroll-custom">
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((item) => {
                    return (
                        <div className="hover:shadow-sm p-7 rounded-xl transition-all cursor-pointer">
                            <img
